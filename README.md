...
## Releases
The last realease is **0.3**. Android app can be downloaded from [Google Play](https://play.google.com/store/apps/details?id=cos.premy.chatovatko.client). UWP client app must be sideloaded.
